...
import { B as require_react, b as require_jsx_runtime, l as require_react_dom, v as Navigate } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { A as CalendarClock, D as Copy, E as Download, O as Clapperboard, S as FileUp, T as Ellipsis, _ as LoaderCircle, a as Trash2, b as LayoutGrid, c as SquareCheckBig, d as Search, f as RefreshCw, h as Minus, k as Check, l as Sparkles, m as Palette, o as Star, p as Plus, r as Upload, s as Square, t as X, u as SlidersHorizontal, v as List, x as House, y as Link2 } from "../_libs/lucide-react.mjs";
import { t as authMiddleware } from "./middleware-BxCdRLFd.mjs";
import { A as recentSeasonOptions, C as kindLabel, D as nextAiringText, E as mediaTitle, F as statusMeta, I as technicalFieldsFromMedia, L as toggleValue, M as searchMetaLine, N as seasonFromDate, O as persistEntries, P as shouldAutoComplete, R as upcomingThisWeek, S as isNextAiringStale, T as mediaKind, _ as fetchMediaByMalId, a as clampProgress, b as filterEntries, c as createSsrRpc, d as enableShare, f as entryFromMedia, g as fetchMediaByIds, h as fetchMediaById, i as canShowRecommendations, j as searchAniListQuery, k as progressText, l as disableShare, m as fetchBySeason, n as STATUSES, o as collectFacets, p as fetchByGenres, r as TRENDING_KEY, s as computeStats, t as Cover, u as downloadWatchlistJson, w as loadEntries, x as getShareSettings, y as fetchTrending } from "./share-aoZ0XyU7.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BSuhKeGw.js
...
function QuickActions({ entry, compact }) {
	...
	const menu = open && pos ? (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref: menuRef,
		role: "menu",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "size-3.5 text-lime" }), "+1 épisode"]
			}),
			...
			!compact ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: Array.from({ length: 10 }, (_, i) => i + 1).map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: cn("size-3.5", entry.rating != null && entry.rating >= n ? "fill-lime text-lime" : "text-line") })
				}, n))
			})] }) : null
		]
	}), document.body) : null;
...
function EntryCard({ entry, compact, onOpen, query = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: progressText(entry) }), entry.rating != null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-0.5 text-lime",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "size-3 fill-lime" }),
									" ",
									entry.rating
								]
							}) : null]
						}),
						nextAiringText(entry) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-1 text-[11px] font-medium text-lime",
							children: nextAiringText(entry)
						}) : null,
						entry.withPeople && entry.withPeople.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HoverPlus, { entry })
		]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				...
				entry.rating != null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-0.5 text-lime",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "size-3 fill-lime" }),
						" ",
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QuickActions, { entry })]
	});
}
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cover, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: added ? "Dans la liste" : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "size-3.5" }), "Ajouter"] })
						})
					]
				})]
			}, m.id);
...
function MediaGridSkeleton({ count = 8 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: Array.from({ length: count }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "aspect-[2/3] w-full animate-pulse bg-line/60" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-2 px-3 py-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-full animate-pulse rounded bg-line/60" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-3/4 animate-pulse rounded bg-line/40" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-full animate-pulse rounded bg-line/50" })
				]
			})]
		}, i))
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-4 text-lime" }), "Suggestions pour toi"]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mb-3 text-[12.5px] text-dim",
				children: ["Basé sur tes genres dominants", topGenres.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					" ",
					"(",
					topGenres.map((g, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [i > 0 ? ", " : "", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaGridSkeleton, { count: 4 }) : null,
			...
			!loading && results.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaGrid, {
				results,
				addedIds: owned,
				onAdd: addEntry
			}) : null
...
function Dashboard() {
	...
	if (entries.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-4" }), "Chercher un anime"]
			})
		]
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), stats.topGenres.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-sm text-dim",
						children: "Pas encore de genres"
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-2 flex flex-wrap gap-1.5",
						children: stats.topGenres.map(([g, n]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
		...
		entries.some((e) => e.status === "Watching") ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "mb-7",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
				className: "font-serif mb-3 flex items-center gap-2 text-[17px] font-medium",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarClock, { className: "size-4 text-lime" }),
					"À venir cette semaine",
					upcoming.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "rounded-full bg-lime/15 px-2 py-0.5 text-[11px] font-bold text-lime tabular-nums",
						children: upcoming.length
					}) : null
				]
			}), upcoming.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		...
		watching.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "mb-7",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				children: watching.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryCard, {
					entry: e,
					compact: true,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				className: "flex gap-3.5 overflow-x-auto pb-1.5",
				children: recent.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryCard, {
					entry: e,
					compact: true,
					onOpen: setActiveEntryId
				}, e.id))
...
function EntryModal() {
	...
	const [personDraft, setPersonDraft] = (0, import_react.useState)("");
	(0, import_react.useEffect)(() => {
		setConfirming(false);
		setTagDraft("");
		setPersonDraft("");
			...
			children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cover, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: entry.genres.slice(0, 4).map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [Array.from({ length: 10 }, (_, i) => i + 1).map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: cn("size-4", entry.rating != null && entry.rating >= n ? "fill-lime text-lime" : "text-line") })
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [entry.tags.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "flex flex-wrap items-center gap-1.5",
						children: [
							withPeople.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("datalist", {
								...
								children: [...new Set(entries.flatMap((e) => e.withPeople || []).filter((n) => n && !withPeople.includes(n)))].sort((a, b) => a.localeCompare(b, "fr")).map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: n }, n))
							})
						]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: `size-4 ${refreshingId === entry.id ? "animate-spin" : ""}` }), refreshingId === entry.id ? "Mise à jour…" : "Mettre à jour les infos AniList"]
				}),
				confirming ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "size-4" }), "Confirmer la suppression"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "size-4" }), "Retirer de la watchlist"]
				})
			]
		})
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					phase === "idle" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm text-dim",
							children: [
								"Dépose un export ",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileUp, { className: "size-8 text-dim" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-dim",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "size-4" }), "Choisir un fichier"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									ref: inputRef,
									type: "file",
					...
					phase === "preview" && preview ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: Object.entries(preview.counts.byStatus).map(([label, n]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						preview.counts.ambiguous > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					phase === "importing" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "mx-auto size-8 animate-spin text-lime" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							progress.total > 50 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Ajoutés" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex justify-between",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Ignorés (déjà présents)" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "tabular-nums text-dim",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex justify-between",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Non reconnus" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "tabular-nums text-dim",
											children: result.unresolved
										})]
									}),
									result.ambiguousMapped > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex justify-between text-amber-200",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Statuts ambigus mappés" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				listQuery ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					"aria-label": "Effacer",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
					...
					children: "Tous"
				}), STATUSES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "size-3.5" }), selectionMode ? "Annuler" : "Sélection"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						...
						children: [
							...
							"Filtres",
							advancedCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: layout === "grid" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(List, { className: "size-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutGrid, { className: "size-4" })
					})
				]
			})]
		}),
		selectionMode ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						allVisibleSelected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "size-4 text-lime" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Square, { className: "size-4" }),
						selectedIds.length,
						" sélectionné",
		...
		filtersOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FacetRow, {
					label: "Genres",
					empty: "Aucun genre pour l’instant",
					children: facets.genres.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FacetRow, {
					label: "Année",
					empty: "Aucune année",
					children: facets.years.map((y) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FacetRow, {
					label: "Studio",
					empty: "Aucun studio",
					children: facets.studios.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FacetRow, {
					...
					children: facets.tags.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FacetRow, {
					...
					children: facets.people.map((person) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterPill, {
						active: peopleFilters.includes(person),
						onClick: () => togglePeopleFilter(person),
						children: person
					}, person))
				}),
				hasAdvanced ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
		...
		list.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			}), entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: "inline-flex items-center gap-2 rounded-[9px] bg-lime px-[18px] py-[11px] text-sm font-bold text-bg",
				onClick: () => setView("search"),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-4" }), "Chercher un anime"]
			...
			children: list.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [selectionMode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: selectedIds.includes(e.id) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "size-5 text-lime" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Square, { className: "size-5 text-dim" })
				}) : null, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: cn(selectedIds.includes(e.id) && selectionMode ? "ring-2 ring-lime rounded-lg" : ""),
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryCard, {
						entry: e,
						onOpen,
						query: listQuery
					})
...
function FacetRow({ label, empty, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: label
	}), has ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function SearchView({ inputRef }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		!error && q.length === 0 && results.length === 0 && searching ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkeletonGrid, {}) : null,
		!error && q.length === 0 && results.length === 0 && !searching ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex items-center gap-2 p-5 text-dim",
			children: "Commence à écrire pour chercher un anime."
		}) : null,
		!error && q.length === 0 && results.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mb-3 text-xs font-semibold text-dim",
			children: "Tendances du moment"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResultsGrid, {
			results,
			query: "",
		...
		!error && q.length > 0 && results.length === 0 && searching ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkeletonGrid, {}) : null,
		!error && q.length > 0 && results.length === 0 && !searching ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		!error && q.length > 0 && results.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResultsGrid, {
			results,
			query: q,
			addedIds: new Set(entries.map((e) => e.anilistId)),
			onAdd: addEntry
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cover, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: (m.genres || []).slice(0, 2).map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full border border-line bg-bg px-2 py-0.5 text-[10.5px] text-dim",
								children: g
							}, g))
						}),
						added ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function SkeletonGrid() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-[210px] animate-pulse bg-line/60" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-2 p-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2.5 rounded bg-line" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2.5 w-[55%] rounded bg-line" })]
			})]
		}, i))
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: ["Saison", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
					value: selectValue,
					onChange: (e) => {
		...
		loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaGridSkeleton, { count: 12 }) : null,
		!loading && !error && results.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "py-10 text-center text-sm text-dim",
			children: "Aucun titre pour cette saison."
		}) : null,
		!loading && results.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaGrid, {
			results,
			addedIds: new Set(entries.map((e) => e.anilistId)),
			onAdd: addEntry
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `absolute top-0.5 left-0.5 size-6 rounded-full bg-bg transition-transform ${enabled ? "translate-x-5" : ""}` })
						})]
					}),
					enabled && shareUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "size-4" }), copied ? "Copié" : "Copier le lien"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[11.5px] text-dim",
...
function AppToast() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: toast.message }), toast.actionLabel && toast.onAction ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
	...
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-[38px] animate-pulse rounded-sm bg-raised" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-5 w-24 animate-pulse rounded bg-raised" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-3 w-28 animate-pulse rounded bg-raised" })]
				})]
			})
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-[76px] animate-pulse rounded-[10px] border border-line bg-raised" }, i))
			})
		})]
	});
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				...
				children: !hydrated ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid grid-cols-2 gap-2.5 sm:grid-cols-5",
					children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-[76px] animate-pulse rounded-[10px] border border-line bg-raised" }, i))
				}) : view === "dashboard" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dashboard, {}) : view === "search" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchView, { inputRef: searchRef }) : view === "season" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SeasonView, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListView, {})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryModal, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImportView, {
				open: importOpen,
				onClose: () => setImportOpen(false)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShareSettings, {
				open: shareOpen,
				onClose: () => setShareOpen(false)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppToast, {})
		]
	});
}
function Home() {
