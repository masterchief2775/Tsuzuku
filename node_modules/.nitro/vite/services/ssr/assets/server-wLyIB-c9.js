import { a as isDynamicBaseURLConfig, c as wildcardMatch, i as getProtocol, l as GENERIC_OAUTH_ERROR_CODES, n as getHost, o as isRequestLike, r as getOrigin, s as resolveBaseURL, t as getBaseURL, u as PACKAGE_VERSION } from "./url-DwGxbmbA.js";
import { n as getPglite, t as ensureDbReady } from "./db-CLcydPFF.js";
...
import { EncryptJWT, SignJWT, base64url, calculateJwkThumbprint, decodeJwt, decodeProtectedHeader, importJWK, jwtDecrypt, jwtVerify } from "jose";
...
import { createRouter, kAPIErrorHeaderSymbol, serializeCookie, serializeSignedCookie, toResponse } from "better-call";
...
import { CompiledQuery, PostgresAdapter, PostgresIntrospector, PostgresQueryCompiler, sql } from "kysely";
...
//#endregion
//#region node_modules/better-auth/dist/plugins/bearer/index.mjs
...
//#endregion
//#region node_modules/better-auth/dist/plugins/generic-oauth/routes.mjs
function isNonEmptyOAuthId$1(id) {
	return id !== void 0 && id !== null && id !== "";
}
var signInWithOAuth2BodySchema = z$1.object({
	providerId: z$1.string().meta({ description: "The provider ID for the OAuth provider" }),
...
var OAuth2CallbackQuerySchema = z$1.object({
	...
	iss: z$1.string().meta({ description: "The issuer identifier" }).optional()
});
...
var OAuth2LinkAccountBodySchema = z$1.object({
	providerId: z$1.string(),
	/**
	* Callback URL to redirect to after the user has signed in.
	*/
...
//#endregion
//#region node_modules/better-auth/dist/plugins/generic-oauth/index.mjs
...
//#endregion
//#region node_modules/better-auth/dist/integrations/cookie-plugin-guard.mjs
/**
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("../index.js").then((n) => n.t);
...
//#endregion
export { GROK_PROVIDERS as i, authConfigured as n, gateIdentityEnabled as r, auth as t };
